...
\IfSubStr*{\jobname}{vitae}{
  \def\positions{
    {1/2012--present}/{MacPorts Team Member}/{MacPorts Project}/{\chicago}/{\macports},
    {8/2010--5/2012}/{Computing Cluster Administrator for \xiaofan}/{\iit}/{\chicago}/{\cluster},
    {1/2010--present}/{PETSc Team Member}/{\anl}/{\chicago}/{\petscdesc},
    {5/2009--present}/{Vice President}/{\lsmsa{} Alumni Association}/{\nat}/{\lsmsaaa}
  }
}{
  \def\positions{}
}
