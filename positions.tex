\IfSubStr*{\jobname}{vitae}{
  \def\kallithea{
    %
    Created an opensource Python clone of Bitbucket / GitHub that supports both
    Git and Mercurial. I improved hi-res graphics, added Font Awesome,
    integrated advanced Mercurial features, and designed evolved changeset
    graphlogs.
    %
  }
}{
  \def\kallithea{
    ...
    \vspace{-4mm}
    \begin{itemize}
      \item Created an opensource Python clone of Bitbucket / GitHub that
      supports both Git and Mercurial
      \item Integrated advanced Mercurial features and designed evolved graphlogs
      \item Created hi-res graphics and scalable icons (Font Awesome)
    \end{itemize}
    %
  }
}
...
\IfSubStr*{\jobname}{vitae}{
  ...
  \def\mercurial{
    ...
    \vspace{-4mm}
    \begin{itemize}
      \item Frequent contributor and maintainer of two extensions: hgsubversion
      and remotenames
      \item Deep understanding of the template engine, changeset evolution, and
      hg-git
    \end{itemize}
    %
  }
...
\IfSubStr*{\jobname}{vitae}{
  ...
  \def\macports{
    ...
    \vspace{-4mm}
    \begin{itemize}
      \item Maintain 220 math, science, and Python ports
      \item Overhauled standardizing compiler variants
      \item Learned how to work with a large team and user base while
...
\IfSubStr*{\jobname}{vitae}{
  \def\positions{
    {2013--now}/{Kallithea Cofounder}/{Kallithea Project}/{}/{\kallithea},
    {2012--now}/{Mercurial Developer and Advocate}/{Mercurial Project}/{}/{\mercurial},
    {2012--now}/{MacPorts Team Member}/{MacPorts Project}/{}/{\macports},
    {2010--2012}/{Computing Cluster Administrator for \xiaofan}/{\iit}/{\chicago}/{\cluster},
    {2010--now}/{PETSc Team Member}/{\anl}/{\chicago}/{\petscdesc},
