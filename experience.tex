...
\IfSubStr*{\jobname}{vitae}{
  \def\fbcontractor{
    ...
    accepted and released in version 3.3. I also created an extension to build
    on top of the namespace api to implement remote branches. This is a work in
    progress but has already received much positive feedback from the
    community.
    %
  }
}{
