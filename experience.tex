...
\IfSubStr*{\jobname}{vitae}{
  \def\summer{
    %
    \setlength\parindent{24pt} \emph{Conceptualized a numerical program for
      solving elliptic equations using MPI and \petsc.}
    \\
...
\IfSubStr*{\jobname}{vitae}{
  \def\dotnet{
    %
    \setlength\parindent{24pt} \emph{Designed an online scheduler for
      photographers that allowed them to coordinate events.}
    \\
