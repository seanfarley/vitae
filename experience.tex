...
\IfSubStr*{\jobname}{vitae}{
  ...
  \def\fbcontractor{
    ...
    \vspace{-4mm}
    \begin{itemize}
      \item Updated low-level merge functions to use in-memory contexts
      \item Implemented transferring general deltas over the wire protocol
      \item Improvement of the record feature to use in-memory contexts
    \end{itemize}
    %
  }
}
...
\IfSubStr*{\jobname}{vitae}{
  ...
  \def\predoc{
    ...
    \begin{itemize}
      ...
      \item Developed advanced nonlinear solvers (non-linear GMRES)
      \item Integrated robust time-stepping methods from \petsc~(IMEX)
...
\IfSubStr*{\jobname}{vitae}{
  ...
  \def\grad{
    ...
    \vspace{-4mm}
    \begin{itemize}
      \item Implemented elliptic finite element code ($P_1, P_2$) for a phase
      field discretization of of the Mumford-Shah functional
  ...
  \def\dotnet{
   %
    ...
    \begin{itemize}
      ...
      \item Utilized Microsoft SQL server by writing stored procedures
      \item Wrote a custom object relational mapper for C\# to MSSQL
...
\IfSubStr*{\jobname}{vitae}{
  ...
  \def\experience{
    {04-07 2014}/{Facebook Contractor}/{Mercurial Project}/{\chicago}/{\noexpand\fbcontractor},
    {06-09 2013}/{Google Summer of Code Student}/{Mercurial Project}/{\chicago}/{\noexpand\gsoc},
    {2010--2013}/{Predoctorate Research Assistant}/{\anl}/{\chicago}/{\noexpand\predoc},
    {2006--2009}/{Graduate Assistant}/{\lsu}/{\br}/{\noexpand\grad},
    {2003--2006}/{.NET Programmer}/{Velocity Squared, LLC}/{\br}/{\noexpand\dotnet},
