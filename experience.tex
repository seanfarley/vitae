...
\IfSubStr*{\jobname}{vitae}{
  ...
  \def\grad{
    %
    Assisted \blaise~by writing finite element (elliptic) code, providing
    proofs, helping with class, building and maintaining a cluster, and building a
    Kerberos-based authentication system for LDAP and Subversion
    authentication.
    %
  }
}
