...
\IfSubStr*{\jobname}{vitae}{
  ...
  \def\dotnet{
   %
    ...
    posting selected photos automatically to a website for sale. Used design
    patterns, databases, threads, security, web services, and xml.
    \newline\newline
    During the immediate aftermath of Hurricane Katrina, our team volunteered
    with the Red Cross keep track of the thousands of newly arrived storm
