\IfSubStr*{\jobname}{vitae}{
  ...
  \def\gsoc{
    %
    Improved the recording feature (arbitrary selection of hunks upon
    committing) and in-memory merging of
...
\IfSubStr*{\jobname}{vitae}{
  ...
  \def\predoc{
    %
    Improved the build system and added framework for new mesh capabilities,
    matrix preallocation, and advanced time-stepping methods to \bout, a
    framework for plasma fusion simulation.
    %
  }
}
...
\IfSubStr*{\jobname}{vitae}{
  ...
  \def\grad{
    %
    Assisted \blaise~by writing code, providing proofs, building and
    maintaining a cluster, building a Kerberos-based authentication system for
    use with LDAP, http, and Subversion authentication, and helping with class
    work.
    %
  }
}
...
\IfSubStr*{\jobname}{vitae}{
  ...
  \def\dotnet{
   %
    Worked on an online scheduler for photographers that allowed them to
    coordinate shooting an event. Our software eased the challenge of
    organizing and executing photo shoots at multiple, distant events as well
    as pulling together masses of photos, uploading them and posting selected
    ones automatically to a for sale website. Used design patterns, databases,
    threads, security, web services, and xml.
    %
    \newline\newline
    %
    During the immediate aftermath of Hurricane Katrina, our team volunteered to
...
\IfSubStr*{\jobname}{vitae}{
  ...
  \def\php{
    %
    Designed web apps with database access using PHP, HTML, javascript, and
    SQL.
    %
  }
}
...
\IfSubStr*{\jobname}{vitae}{
  ...
  \def\experience{
    ...
    {06-09 2006}/{Research Programmer with \blaise}/{\lsu}/{\br}/{\noexpand\summer},
