...
\IfSubStr*{\jobname}{vitae}{
  ...
  \def\predoc{
    ...
    \begin{itemize}
      ...
      \item Implemented approximate matrix preallocation
...
\IfSubStr*{\jobname}{vitae}{
  ...
  \def\grad{
    ...
    \begin{itemize}
      ...
      \item Provided theoretical support for class (e.g. proofs)
      \item Built and maintained a cluster
      \item Implemented a Kerberos authentication system for LDAP and Subversion
    \end{itemize}
    %
  }
}
