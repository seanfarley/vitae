...
\IfSubStr*{\jobname}{vitae}{
  ...
  \def\fbcontractor{
    ...
    \vspace{-4mm}
    \begin{itemize}
      \item Revamped backend file-merge method to be in-memory
      \item Proposed and implemented namespaces for branches and bookmarks with
        positive review from the community
    \end{itemize}
    %
  }
}
...
\IfSubStr*{\jobname}{vitae}{
  ...
  \def\gsoc{
    ...
    \vspace{-4mm}
    \begin{itemize}
      \item Engineered a deep refactor of changesets in-memory
...
\IfSubStr*{\jobname}{vitae}{
  ...
  \def\dotnet{
   %
    \vspace{-4mm}
    \begin{itemize}
      \item Designed an Microsoft SQL based scheduler with C\# for photographers
