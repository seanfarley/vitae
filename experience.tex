\IfSubStr*{\jobname}{vitae}{
  ...
  \def\gsoc{
    ...
    \vspace{-4mm}
    \begin{itemize}
      \item Deep rework of internal representation of a changeset in memory
      \item This has opened the way for major improvement in the partial commit
      interface and in-memory rebase
...
\IfSubStr*{\jobname}{vitae}{
  ...
  \def\predoc{
    ...
    \vspace{-4mm}
    \begin{itemize}
      \item Improved the build system of \bout, a framework for fusion simulation
      \item Added framework for new mesh capabilities, matrix preallocation,
      and advanced time-stepping methods to \bout
    \end{itemize}
    %
  }
}
...
\IfSubStr*{\jobname}{vitae}{
  ...
  \def\grad{
    ...
    \vspace{-4mm}
    \begin{itemize}
      \item Assisted \blaise~by writing finite element (elliptic) code
      \item Provided proofs to help with class
      \item Built and maintained a cluster
      \item Implemented a Kerberos-based authentication system for LDAP and Subversion
    \end{itemize}
    %
  }
}
...
\IfSubStr*{\jobname}{vitae}{
  ...
  \def\dotnet{
   %
    \vspace{-4mm}
    \begin{itemize}
      \item Wrote an online schedule for photographers that allowed them to
      coordinate shooting events, and managing the logistics of uploading and
      posting selected photos automatically to a website for sale
      \item Used design patterns, databases, threads, security, web services,
      and xml.
      \item Organized a 72-hour coding sprint during Hurricane Katrina to write
      a program to help keep track of refuges. Utilized fuzzy text searching,
