...
%
  ...
  hunks upon committing) of \href{http://mercurial.selenic.com}{Mercurial}. This summer
...
%
  ...
  build system and software organization. The majority of the work involved
  improving meshing capabilities to add matrix preallocation for the
...
%
  ...
  \texttt{SuperLU}). Specifically, I fixed linking with \texttt{METIS} /
...
\cvlistitem{Compiled, setup, and maintained DHCP, DNS, LDAP, kerberos
  authentication, database, and email servers on FreeBSD and other *nix
  operating systems}
